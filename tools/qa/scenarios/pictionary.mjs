...
export async function run() {
    ...
    return r.run(async (r) => {
        ...
        const round1Ended = await alice.waitForEvent('pict.round_ended', 3_000)
        ...
        const round2 = await alice.waitForEvent('pict.round_started', 5_000)
        ...
        const round2Ended = await alice.waitForEvent('pict.round_ended', 3_000)
        ...
        const ended = await alice.waitForEvent('game.ended', 5_000)
